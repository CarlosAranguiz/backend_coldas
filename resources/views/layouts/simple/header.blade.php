<div class="page-header">
  <div class="header-wrapper row m-0">
    ...
    <div class="header-logo-wrapper col-auto p-0">
      <div class="logo-wrapper"><a href="{{route('dashboard')}}"><img class="img-fluid" width="97px" height="28px" src="{{asset('assets/images/logo/logo_rad_solo.png')}}" alt=""></a></div>
      ...
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          <div class="media profile-media">
            <img class="b-r-10" src="{{asset('assets/images/logo/identidad_videos.png')}}" width="37px" height="37px" alt="">
            <div class="media-body">
