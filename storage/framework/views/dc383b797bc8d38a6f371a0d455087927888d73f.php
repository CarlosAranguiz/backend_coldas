				...
				<div class="card-body">
					<div class="media align-items-center">
						...
						<div class="knob-block text-center">
							<input class="knob1" data-width="10" data-height="70" data-thickness=".3" data-angleoffset="0" data-linecap="round" data-fgcolor="#0ec4cb" data-bgcolor="#eef5fb" value="60">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="card">
				<div class="card-body">
					<div class="media align-items-center">
						...
						<div class="knob-block text-center">
							<input class="knob1" data-width="50" data-height="70" data-thickness=".3" data-fgcolor="#0ec4cb" data-linecap="round" data-angleoffset="0" value="60">
						</div>
					</div>
				</div>
			</div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/cuba_starter_kit/resources/views/dashboard/index.blade.php ENDPATH**/ ?>