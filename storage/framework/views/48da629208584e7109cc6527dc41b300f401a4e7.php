							...
							<thead>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $historiales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $historial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="odd">
                                            <td><?php echo e($historial->alumno->rut ?? 'NO HAY REGISTRO'); ?></td>
                                            <td><?php echo e(($historial->alumno->nombre ?? 'NO HAY REGISTRO ').' '.($historial->alumno->apellido_paterno ?? 'NO HAY REGISTRO') ?? 'No posee'); ?></td>
                                            <td><?php echo e($historial->descripcion ?? 'NO HAY REGISTRO'); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/carlos/Documents/Backend/backend_coldas/resources/views/administracion/historial/index.blade.php ENDPATH**/ ?>