							...
							<thead>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $question->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="odd">
                                            <td><?php echo e($option->option_text ?? 'NO HAY REGISTRO '); ?></td>
                                            <td style="width: 13%">
                                                <a class="btn btn-danger" href="<?php echo e(route('posteventoptions.destroy',$question)); ?>" >Eliminar</button>
                                            </td>
                                        </tr>
...
<div class="modal fade" id="crear_opcion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('posteventoptions.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="modal-body">
                <input type="hidden" name="post_event_question_id" value="<?php echo e($question->id); ?>">
                <div class="row">
                    <div class="col-12">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/carlos/Documents/Backend/backend_coldas/resources/views/administracion/eventos/options.blade.php ENDPATH**/ ?>